 ...
 */
public class SubscriptionCategorySelectListener implements View.OnClickListener {
    ...
    public SubscriptionCategorySelectListener(View parentRootView) {
    ...
    public void onClick(View v) {
        ...
        categoryTextView = (TextView) v.findViewById(R.id.pESubscribeCategorySelectLabel);
