...
import com.adithya.activity.MainActivity;

/**
 * Created by tirrumalaubuntu on 6/6/15.
 */
public class SubCategorySelectListener implements View.OnClickListener {
    ...
    public SubCategorySelectListener(View parentRootView) {
    ...
    public void onClick(View v) {
        ...
        subCategoryValueText = (EditText) parentRootView.findViewById(R.id.pECategorySelectEditText);
