 ...
 */
public class InboxItemSelectListener implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public InboxItemSelectListener(View parentRootView) {
